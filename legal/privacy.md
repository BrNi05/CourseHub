...
**Hatályba lép:** 2026.07.07. (kilencedik verzió)
...
- **Kezelt adatok:** Google fiók azonosító (googleId), email cím, fiók létrehozásának dátuma, utolsó sikeres bejelentkezés időpontja.

- **Nem kezeljük:** Google jelszó, Google hozzáférési tokenek (access tokens).

- **Cél:** Az Érintett azonosítása, egyedi felhasználói profil biztosítása, adattakarékossági megfelelés, Ekertv. szerinti megkeresés.
...
A CourseHub átlag kalkulátora bejelentkezés nélkül is használható, ilyenkor az adatok kizárólag a felhasználó böngészőjének helyi tárhelyében (`localStorage`) kerülnek mentésre. Bejelentkezett felhasználó a kalkulátor állapotát a szerverre is mentheti a profiljához kapcsolva.
...
- **Megjegyzés:** _Az átlag kalkulátorban megadott tárgyak, jegyek és félév információk közvetett és közvetlen módon utalhatnak az Érintett tanulmányi előmenetelére, intézményére, karára vagy szakjára. A funkció használata önkéntes, szerveroldali mentés csak bejelentkezett felhasználó kifejezett mentési művelete után történik._
...
- Törlési feltétel: Amennyiben az Érintett a fiókjában 36 hónapig (3 évig) nem végez profilt módosító aktív tevékenységet – amely a CourseHub esetében egyelőre kizárólag az átlag kalkulátor szerveroldali mentését (használatát) jelenti –, a rendszer a felhasználói profilt inaktívnak minősíti. Ennek oka, hogy a szolgáltatás oktatási rendeltetéséből fakadóan a 3 éves egybefüggő inaktivitás – amely hat egyetemi félévnyi időt jelent – alapján megalapozottan arra lehet következtetni, hogy az Érintett már nem tart igényt a szolgáltatásra.
...
- Kivétel: A biztonsági naplókban szereplő azonosítók a fenti 3 éves megőrzési idő után, vagy a fiók törlésekor anonimizálásra kerülnek, így azok a továbbiakban nem minősülnek személyes adatnak.
...
| Szolgáltató     | Tevékenység                 | Székhely |    Jogállás    |
| --------------- | --------------------------- | -------- | -------------- |
| Cloudflare Inc. | Peremvédelem                | USA / EU | adatfeldolgozó |
| Google LLC      | Hitelesítés (OAuth2)        | USA / EU | adatkezelő     |
| GitHub Inc.     | Javaslatok fogadása         | USA      | adatkezelő     |
...
A Cloudflare Adatvédelmi Tájékoztatója elérhető [itt](https://www.cloudflare.com/en-gb/privacypolicy/), az Adatfeldolgozói Szerződés [itt](https://www.cloudflare.com/cloudflare-customer-dpa/).
